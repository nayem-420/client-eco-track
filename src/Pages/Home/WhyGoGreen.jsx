...
import { FaBolt, FaGlobeAsia, FaHeart, FaLeaf, FaWater } from "react-icons/fa";
...
const WhyGoGreen = () => {
  ...
  return (
    <section className="py-16 bg-linear-to-br from-green-50 to-green-100 text-gray-800 overflow-hidden my-8 rounded-2xl">
      <motion.div
